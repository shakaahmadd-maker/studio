...
export default function ServicePage({ params }: ServicePageProps) {
  ...
  const relevantFaqs = faqs.filter(f => f.category === service.id || f.category === 'general');
  const relevantStories = successStories.slice(0,2); // Show a couple of generic success stories
