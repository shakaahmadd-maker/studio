...
export const universities: University[] = [
  { name: 'Technical University of Munich', logoUrl: '/logos/tum.svg' },
  { name: 'LMU Munich', logoUrl: '/logos/lmu.svg' },
  { name: 'Heidelberg University', logoUrl: '/logos/heidelberg.svg' },
  { name: 'Free University of Berlin', logoUrl: '/logos/fu-berlin.svg' },
  { name: 'Humboldt University of Berlin', logoUrl: '/logos/hu-berlin.svg' },
  { name: 'RWTH Aachen University', logoUrl: '/logos/rwth-aachen.svg' },
  { name: 'Karlsruhe Institute of Technology', logoUrl: '/logos/kit.svg' },
  { name: 'University of Hamburg', logoUrl: '/logos/hamburg.svg' },
  { name: 'University of Cologne', logoUrl: '/logos/cologne.svg' },
  { name: 'University of Göttingen', logoUrl: '/logos/goettingen.svg' },
  { name: 'University of Stuttgart', logoUrl: '/logos/stuttgart.svg' },
  { name: 'University of Tübingen', logoUrl: '/logos/tuebingen.svg' },
  { name: 'University of Mannheim', logoUrl: '/logos/mannheim.svg' },
  { name: 'University of Leipzig', logoUrl: '/logos/leipzig.svg' },
  { name: 'University of Freiburg', logoUrl: '/logos/freiburg.svg' },
  { name: 'University of Würzburg', logoUrl: '/logos/wuerzburg.svg' },
  { name: 'University of Erlangen-Nuremberg', logoUrl: '/logos/erlangen-nuremberg.svg' },
  { name: 'University of Bielefeld', logoUrl: '/logos/bielefeld.svg' },
  { name: 'University of Marburg', logoUrl: '/logos/marburg.svg' },
  { name: 'Université Paris-Saclay', logoUrl: '/logos/paris-saclay.svg' },
  { name: 'Sorbonne University', logoUrl: '/logos/sorbonne.svg' },
  { name: 'University of Strasbourg', logoUrl: '/logos/strasbourg.svg' },
  { name: 'University of Bordeaux', logoUrl: '/logos/bordeaux.svg' },
  { name: 'University of Lyon', logoUrl: '/logos/lyon.svg' },
  { name: 'Université Grenoble Alpes', logoUrl: '/logos/grenoble-alpes.svg' },
  { name: 'Université Toulouse III - Paul Sabatier', logoUrl: '/logos/toulouse.svg' },
  { name: 'University of Montpellier', logoUrl: '/logos/montpellier.svg' },
  { name: 'University of Lille', logoUrl: '/logos/lille.svg' },
  { name: 'Aix-Marseille University', logoUrl: '/logos/aix-marseille.svg' },
  { name: 'University of Bologna', logoUrl: '/logos/bologna.svg' },
  { name: 'University of Milan', logoUrl: '/logos/milan.svg' },
  { name: 'Sapienza University of Rome', logoUrl: '/logos/sapienza.svg' },
  { name: 'University of Padua', logoUrl: '/logos/padua.svg' },
  { name: 'University of Florence', logoUrl: '/logos/florence.svg' },
  { name: 'University of Pisa', logoUrl: '/logos/pisa.svg' },
  { name: 'University of Turin', logoUrl: '/logos/turin.svg' },
  { name: 'University of Naples Federico II', logoUrl: '/logos/naples.svg' },
  { name: 'Ca\' Foscari University of Venice', logoUrl: '/logos/venice.svg' },
  { name: 'University of Siena', logoUrl: '/logos/siena.svg' },
  { name: 'University of Oxford', logoUrl: '/logos/oxford.svg' },
  { name: 'University of Cambridge', logoUrl: '/logos/cambridge.svg' },
  { name: 'University College London', logoUrl: '/logos/ucl.svg' },
  { name: 'University of Edinburgh', logoUrl: '/logos/edinburgh.svg' },
  { name: 'University of Manchester', logoUrl: '/logos/manchester.svg' },
  { name: 'University of Glasgow', logoUrl: '/logos/glasgow.svg' },
  { name: 'University of Birmingham', logoUrl: '/logos/birmingham.svg' },
  { name: 'University of Bristol', logoUrl: '/logos/bristol.svg' },
  { name: 'University of Warwick', logoUrl: '/logos/warwick.svg' },
  { name: 'University of Leeds', logoUrl: '/logos/leeds.svg' },
  { name: 'University of California, Berkeley', logoUrl: '/logos/berkeley.svg' },
  { name: 'University of California, Los Angeles', logoUrl: '/logos/ucla.svg' },
  { name: 'University of Michigan, Ann Arbor', logoUrl: '/logos/michigan.svg' },
  { name: 'University of California, San Diego', logoUrl: '/logos/ucsd.svg' },
  { name: 'University of California, San Francisco', logoUrl: '/logos/ucsf.svg' },
  { name: 'University of Virginia', logoUrl: '/logos/virginia.svg' },
  { name: 'University of North Carolina at Chapel Hill', logoUrl: '/logos/unc.svg' },
  { name: 'University of Illinois Urbana-Champaign', logoUrl: '/logos/illinois.svg' },
  { name: 'University of Washington, Seattle', logoUrl: '/logos/washington.svg' },
  { name: 'University of California, Santa Barbara', logoUrl: '/logos/ucsb.svg' },
];
